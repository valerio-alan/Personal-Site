        ...
        <div className="project" style={{['--project-bg-color']: props.data.colors.backgroundColor, ['--project-text-color']: 'var(--off-white)'}}>
            ...
            <div className="project-tags">
                {props.data.tags.map((tag, i) => (projectsData.tags[tag].link ?
                        <a key={i} className="project-tag unselectable show-tooltip" tooltip-text={`Learn more about ${projectsData.tags[tag].name}`} href={projectsData.tags[tag].link} target="_blank" rel="noopener" style={{['--tag-color']: projectsData.tags[tag].color}}>{projectsData.tags[tag].name}</a> :
            ...
            <div className="project-links unselectable">
                {props.data.links.github && <a className="project-link show-tooltip" tooltip-text='View the source code' href={props.data.links.github} target="_blank" rel="noopener"><img className="project-link-icon" src={githubLogo} alt="Github logo"/></a>}
                {props.data.links.production && <a className="project-link show-tooltip" tooltip-text='View the project' href={props.data.links.production} target="_blank" rel="noopener"><img className="project-link-icon" src={openLink} alt="Open link icon"/></a>}
            </div>
        </div>
    )
}