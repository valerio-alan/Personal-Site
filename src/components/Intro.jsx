...
export default function Intro() {
  useEffect(() => {
    ...
    var update = function (event) {
      ...
      updateTransformStyle((((e.clientY - e.target.getAttribute('_y')) * -1) / inner.offsetHeight / 2).toFixed(2), ((e.clientX - e.target.getAttribute('_x')) / inner.offsetWidth / 2).toFixed(2));
    };
  ...
  return (
    <Section header={false} id='intro'>
      ...
      <div className='intro-img-wrapper unselectable'>
        ...
        <a className='social-bubble linkedin-bubble show-tooltip' tooltip-text='Visit my LinkedIn profile' href='https://www.linkedin.com/in/alan-valerio/' target='_blank'>
      ...
      <div className='intro-text'>
        {desktopBubblesEls}
        <h3>
          Hello! My name is <BounceText classes='purple name-title'>Alan Valerio</BounceText>.
        </h3>
        <p>
          I’m a <BounceText classes='purple'>web developer</BounceText> and <BounceText classes='purple'>automation engineer</BounceText> with an eye for <BounceText classes='purple'>design</BounceText>.
        </p>
        <p>I’ve had the honor of working with many clients, and have gained further experience through my own personal projects.</p>
