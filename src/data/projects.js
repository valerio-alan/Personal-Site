  ...
  data: [
    {
      ...
      tags: ['html/css/js', 'python', 'netlify', 'mongodb', 'fullstack'],
      colors: '49, 50, 57',
    },
    {
      title: "Jane Casto's Portfolio",
      description: 'I designed and developed this clean and effective portfolio site for policy and data analyst Jane Casto. With a focus on clean design and user-friendly functionality, this site showcases her work and skills while making it easy for potential clients to contact her.',
      links: {
    ...
    },
    {
      title: 'The Quizzler',
      label: 'Early Access',
      description: "This twist on a classic childhood game has become a passion project of mine. I've always wanted to create interactive and challenging experiences for anybody to enjoy, and I believe this game achieves that. This project also allowed me to learn about serverless functions and build a secure backend.",
    ...
    },
    {
      ...
      label: 'Private Commission',
      description: 'Created for a small family-owned business in New York, this tool collects relevant product information from a large collection of sources. Automating the collection of this information has saved hours of valuable time for this business, and streamlined the process of maintaining a catalog of over 15,000 products',
      links: {},
